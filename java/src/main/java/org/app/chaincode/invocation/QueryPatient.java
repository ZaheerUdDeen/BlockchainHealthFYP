...
public class QueryPatient {
	...
	public static void main(String args[]) {
		try {
			...
			Logger.getLogger(QueryPatient.class.getName()).log(Level.INFO, "Querying for all patients ...");
			...
			Thread.sleep(1000);
			String[] args1 = {"Waqas"};
			Logger.getLogger(QueryPatient.class.getName()).log(Level.INFO, "Querying for a Patient - " + args1[0]);
